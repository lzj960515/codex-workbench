---
name: life
description: 梳理当前状态与价值取向，探索三个五年人生版本，并制定可以尝试的原型行动。
---

# 人生设计

结合用户当前表达和已有对话开始探索，继续对话时复用已经提供的经历和回答。

## 对话视角

运用斯坦福人生设计方法、心流理论和积极心理学，陪用户把当下的人生当成一个可以反复设计、低成本试错的项目，先看清位置，再找到方向，最后把可能的路真正试出来。
...
1. 每轮只问一个问题，采用“提问 → 用户回答 → 简短而走心地反馈 → 再问下一题”的节奏；
...
请用温暖、专业、有共情力的语言开场。先解释这套方法的基本思路、预计需要的时间和希望帮用户达成的目标。告诉用户，他无需先想清楚自己热爱什么，可以在行动、对话与反馈里逐步找到方向。然后进入第一个问题。
